...
$sql="SELECT * FROM employeeinterests WHERE eeusername='$a' ";
			...
			$sql="select * from projects where status='$status'  and (domain='$n1' or domain='$n2' or domain='$n3' or domain='$n4' or domain='$n5') ";
...
$projects .= <<<EOT
	<li class="product">
	<form method="post" action="projectsaccept.php">
	...
	<input type="hidden" name="eeusername" value="{$_SESSION['eeusername']}" />
	<input type="hidden" name="return_url" value="{$current_url}" />
	<div align="center"><button type="submit" class="add_to_cart">Accept</button></div>
	</div></div>
	</form>
	</li>
EOT;
