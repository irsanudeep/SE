$(window).load(function () {
	...
	wheel03 = new TimelineMax({repeat: 5000, timeScale: 2});
	wheel03.add(tl01, 0);
	wheel03.add(tl02, 0);
	wheel03.add(tl03, 0);
	wheel03.add(tl04, 0);
	...
	TweenMax.to(wheel03, 2.5, {timeScale: 1, ease: Circ.easeOut})
	TweenMax.to(wheel03, 50.9, {timeScale: 1, delay: 2, ease: Circ.easeOut})
});